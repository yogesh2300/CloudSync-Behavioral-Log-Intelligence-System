...
import { Activity, HardDrive, RadioTower, Server as ServerIcon } from 'lucide-react'
import {
...
export default function Servers() {
  ...
  const collectFromServer = async (server) => {
    ...
    setMessage(`${server.server_name}: ${r.collected_events ?? r.inserted} events collected`)
  }
        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          <Button
            ...
            onClick={() => runAction(s.id, async () => {
              ...
              setMessage(`${s.server_name}: ${r.collected_events ?? r.inserted} events collected`)
            })}
          >
            Collect Logs
          </Button>
